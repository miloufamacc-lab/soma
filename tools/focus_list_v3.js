...
function refreshAllData() {
  ...
  for (var i = 0; i < TICKERS.length; i++) {
    ...
    try {
      ...
      // Sales growth is already a percentage (e.g., 48 means 48%)
      ...
      // Store salesGrowth as decimal for sheet formatting (e.g., 0.48 for 48%)
...
function sendDailyEmail() {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    var salesGrowth = data[i][9] * 100; // Convert back from decimal
    ...
    <div style="background: ${cardBg}; ${borderLeft} padding: 12px; margin-bottom: 8px; border-radius: 6px; box-shadow: 0 1px 2px rgba(0,0,0,0.05);">
      ...
      <div style="display: flex; gap: 8px; flex-wrap: wrap;">
        <span style="background: #f1f5f9; padding: 3px 8px; border-radius: 4px; font-size: 11px; color: ${growthColor};">
